...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
'because in javascript a closure gives you access to an outer function’s scope from an inner function.'
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(data){
    const zoo = zooAnimals.forEach((animal_name, scientific_name) => {
      console.log(animal_name, scientific_name);
      return displayNames = ["name: {name}, scientific: {scientific_name}"];
    });
  }
...
console.log(lowerCaseNames);
  ...
  */
  ...
  function lowPopulationAnimals(number){
    const lowPopFilter = zooAnimals.filter(number => number.population);
    return lowPopFilter;
  }
console.log(lowPopulationAnimals);
  ...
  */
  ...
  function USApop(zooAnimals){
    const reducePop = zooAnimals.reduce((total, state) => {
